                    ...
                    <div class="card-body p-md-5 mx-md-4">
                      ...
                      <form method="POST" action="{{route('/two-factor-challenge')}}">
                        ...
                        <div class="form-outline mb-4">
                          ...
                          <input type="text" id="form2Example22" name="code" class="form-control" />
                          <label class="form-label" for="form2Example22">Code</label>
                        </div>
                      ...
                      <form method="POST" action="{{url('/two-factor-challenge')}}">
                        ...
                        <div class="form-outline mb-4">
                          ...
                          <input type="text" id="form2Example22" name="recovery_code" class="form-control" />
                          <label class="form-label" for="form2Example22">Code</label>
                        </div>
